...
require([
  ...
  "dijit/form/Button", "dojo/domReady!"
     ...
     var dndSource = new Source("layerList5");
     dndSource.on("DndDrop", reorderLayers);

     topographie = new ArcGISDynamicMapServiceLayer("http://repos.sig.huma-num.fr/arcgis/rest/services/medievalgis/Rasters/MapServer", {
        "id": "rasters"
     });
...
table.push(topographie);
       ...
       function buildLayerList() {
        ...
        domConstruct.empty(dom.byId("layerList5"));
     ...
     function getVisibleLayers() {
        ...
        var layerOrder = [];
        query("#layerList5 .dojoDndItem label").forEach(function (n, idx) {
           for (var info in infos) {
              var i = infos[info];
